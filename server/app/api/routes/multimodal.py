...
from app.schemas import MultimodalChatResponse, SpeechSynthesisRequest
from app.services.multimodal_service import chat_with_audio, chat_with_image, synthesize_speech
